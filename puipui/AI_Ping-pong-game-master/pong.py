...
class PongGame:
	...
	def getNextFrame(self,action):
		...
		self.Paddle2_Y_Pos=updatePaddle2(self.Ball_Y_Pos, self.Paddle2_Y_Pos)
		drawPaddle2(self.Paddle2_Y_Pos)

		[score,Paddle1_Y_Pos,Paddle2_Y_Pos,Ball_X_Pos,Ball_Y_Pos,Ball_X_Direction,Ball_Y_Direction] = updateBall(
			self.Paddle1_Y_Pos, self.Paddle2_Y_Pos, self.Ball_X_Pos, self.Ball_Y_Pos, self.Ball_X_Direction,
			self.Ball_Y_Direction)
